...
const TaskListTable = ({ tableData }) => {
  ...
  return (
    // Your JSX table rendering logic should go here.
    <div className='overflow-x-auto p-0 rounded-lg mt-3'>
        <table className='min-w-full'>
            <thead>
                <tr className='text-left'>
                    <th className='py-3 text-gray-800 font-medium text-[13px]'>Name</th>
                    <th className='py-3 text-gray-800 font-medium text-[13px]'>Status</th>
                    <th className='py-3 text-gray-800 font-medium text-[13px]'>Priority</th>
                    <th className='py-3 text-gray-800 font-medium text-[13px] hidden md:table-cell'>Created On</th>
                </tr>
            </thead>
            <tbody>
                {tableData.map((task)=>(
